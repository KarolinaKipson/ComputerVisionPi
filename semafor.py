...
colorRanges = [
        ((70, 100, 10), (95, 255, 255), "green"),
        ((10, 130, 10), (60, 255, 255), "yellow"),
        ((160, 130, 10), (190, 255, 255), "red")]
...
# add motor with pins
motor1 = utils.Motor(13, 26, 19)
motor2 = utils.Motor(16, 21, 20)
...
# cleanup the camera, GPIO pins and close any open windows
GPIO.cleanup()
camera.release()
